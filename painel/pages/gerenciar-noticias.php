...
<div class="box-content">
    <h2><i class="fas fa-newspaper"></i> Noticias Cadastrados</h2>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td><a href="<?php echo INCLUDE_PATH_PAINEL ?>editar-noticia?id=<?php echo $value['id']; ?>" class="btn edit"><i class="fa fa-pencil"></i> Editar</a></td>
                    <td><a actionBtn="delete" href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-noticias?excluir=<?php echo $value['id']; ?>" class="btn delete"><i class="fa fa-times"></i> Deletar</a></td>
